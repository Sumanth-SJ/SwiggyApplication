...
import { restaurantSignupSchema } from "../../formik/FormValication";
...
const RSignUp = () => {
  ...
  const addSignUpData = async(data)=>{
    const response = await axios.post(serverUrl+"auth/restaurant/singup",data);
    return response.data;
  }


  const signUpMutation = useMutation({
    mutationKey:"restaurant-signup",
  ...
  return (
    <section className="w-full h-screen bg-white relative">
      <article className="p-2 md:p-5 w-[300px] md:w-[400px] absolute top-[50%] -translate-y-[50%] right-5 rounded-lg shadow-md bg-white">
        ...
        <Formik
         initialValues={{name:"",email:"",address:"",password:"",cpassword:"",phoneNumber:""}}
              ...
              <Form className="flex flex-col justify-start items-start">
                ...
                </div>
                {
                  ...
                  <div className="w-full flex justify-center items-center mt-4">
                     <button 
                     className={`w-[80%] p-2 rounded-xl bg-[#feb80a] flex justify-center items-center mx-auto ${signUpMutation.isPending ? "cursor-not-allowed" : ""} `} type="submit">
                  ...
                  <div className="mt-2 flex justify-start items-center w-full">
                   ...
                   {/* <p className="mt-2 text-center w-full text-[0.75rem]">
                    Already have an account ? <span onClick={ha}>Sign In</span>
                   </p> */}
              </Form>
            );
          }}
